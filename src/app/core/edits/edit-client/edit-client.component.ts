...
export class EditClientComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.getAllclientById();
  }
  getAllclientById(){
    this.clientService.getClientById(this.personId).subscribe((data)=>{
      this.clientDates = data;

      this.clientForm.patchValue({
        personName:this.clientDates.personName,
        personEmail:this.clientDates.personEmail,
        personDocumentTypeId:this.clientDates.personDocumentTypeId,
        personPhone:this.clientDates.personPhone,
        personAddress:this.clientDates.personAddress,
        personLastName:this.clientDates.personLastName,
        personDocument:this.clientDates.personDocument,
  ...
  clientSave() {
    if (this.clientForm.valid) {
      ...
      this.clientService.updateClient(this.personId,data).subscribe({
        next:()=>{
          Swal.fire(
